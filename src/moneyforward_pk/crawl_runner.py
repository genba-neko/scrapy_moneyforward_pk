...
::
    ...
    cd src
    python -m moneyforward_pk.crawl_runner
    python -m moneyforward_pk.crawl_runner --type transaction
    python -m moneyforward_pk.crawl_runner --site xmf_ssnb
    python -m moneyforward_pk.crawl_runner --list
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        prog="moneyforward_pk.crawl_runner",
